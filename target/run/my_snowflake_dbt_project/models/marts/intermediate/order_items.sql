...
create or replace iceberg table ICEBERG_DB.SAMPLE_DB_ICEBERG.order_items
    

    external_volume = 'iceberg_external_volume'

    catalog = 'SNOWFLAKE'  -- required, and always SNOWFLAKE for built-in Iceberg tables
    base_location = '_dbt/SAMPLE_DB_ICEBERG/order_items/intm_order_items'
...
line_item as (
    ...
    select * from ICEBERG_DB.SAMPLE_DB_ICEBERG_staging.stg_tpch_line_items
